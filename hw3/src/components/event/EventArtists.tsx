      ...
      <div className="space-y-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-8">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-semibold">{artistData.name}</h2>
            {artistData.followers?.total ? (
              <p className="text-muted-foreground">
                Followers: {formatNumberWithCommas(artistData.followers.total)}
              </p>
            ) : null}
            {typeof artistData.popularity === 'number' ? (
              <p className="text-muted-foreground">Popularity: {artistData.popularity}</p>
            ) : null}
