            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div className={cn("h-5 mt-1", !errors.keyword && "invisible")}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div className={cn("h-5 mt-1", !errors.category && "invisible")}>
                    <FormMessage className="text-red-500 text-xs" />
                  </div>
                </FormItem>
              )}
                ...
                <FormItem>
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-medium text-muted-foreground whitespace-nowrap">Auto-detect</span>
                      <Switch
                        id="autoDetect"
